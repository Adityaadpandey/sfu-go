...
import { ConnectionQuality, Peer, RoomStatus, TrackInfo } from "../types";
...
interface RoomState {
    ...
    // Network condition (inLive SFU pattern)
    networkCondition: 'good' | 'degraded' | 'poor' | null;
    ...
    // Network condition
    setNetworkCondition: (condition: 'good' | 'degraded' | 'poor' | null) => void;
